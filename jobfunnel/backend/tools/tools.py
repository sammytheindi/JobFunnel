...
def get_webdriver():
    ...
    # Can add UC Mode support for Brave and Opera
    # See here: https://github.com/seleniumbase/SeleniumBase/discussions/2547
    try:
        ...
        raise RuntimeError(
            ...
            "the following installed to scrape: [Chrome]"
        )
